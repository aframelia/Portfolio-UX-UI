import { User, Wrench, Clock, Target, Heart } from "lucide-react";
  ...
  return (
    <section className="py-16 px-6 relative">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="bg-card rounded-2xl p-8 shadow-sm border">
            ...
            <p className="text-muted-foreground">Figma, Miro, Webflow</p>
          </div>
          ...
          <div className="bg-card rounded-2xl p-8 shadow-sm border">
            ...
            <p className="text-muted-foreground">Redirect users to the app.</p>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-8 right-8 transform rotate-12">
        <Heart className="w-8 h-8 text-peach" />
      </div>
    </section>
  );
};

export default BhiveMeta;