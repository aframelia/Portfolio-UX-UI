...
const Index = () => {
  ...
  const allPortfolioItems = [
    ...
    {
      title: t('portfolio.bhive.title'),
      category: t('portfolio.bhive.category'),
      image: "/dektoppage.png",
      bg: "bg-gradient-to-br from-peach to-peach-light",
      description: t('portfolio.bhive.description'),
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="flex gap-6 justify-center md:justify-start">
              ...
              <a
                href="https://github.com/aframelia"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors"
              >
              ...
              <a
                href="https://instagram.com/uxafra"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors"
              >
